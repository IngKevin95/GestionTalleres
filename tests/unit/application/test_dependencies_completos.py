...
def test_obtener_repositorio_con_sesion():
    sesion_mock = Mock()
...
def test_obtener_auditoria_instancia():
    auditoria = obtener_auditoria()
    
    assert isinstance(auditoria, AlmacenEventosLogger)


def test_obtener_action_service_completo():
    sesion_mock = Mock()
...
def test_obtener_repositorio_cliente_con_sesion():
    sesion_mock = Mock()
...
def test_obtener_repositorio_vehiculo_con_sesion():
    sesion_mock = Mock()
